...
add_button = fsg.Button(image_source="add.png", image_size=(40, 30) ,tooltip="Add todo", mouseover_colors="white", key='Add')

list_box = fsg.Listbox(values=[todo.strip("\n") for todo in functions.get_todos()], size=(40, 10), key='todos', enable_events=True)
edit_button = fsg.Button("Edit", size=(4,1), tooltip="Edit todo", mouseover_colors="white")
complete_button = fsg.Button(image_source="complete.png", image_size=(45, 35) , tooltip="Complete todo", mouseover_colors="white", key='Complete')
